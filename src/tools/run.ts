 ...
 */
async function sendAssertionLog(
  server: McpServer | undefined,
 ...
 */
export async function runSuiteTool(opts: RunToolOptions): Promise<string> {
 ...
 */
export async function runCaseTool(name: string, opts: RunToolOptions): Promise<string> {
